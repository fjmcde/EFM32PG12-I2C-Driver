...
// compiler directive to use application specific I2C0 peripheral
  ...
  #define APP_I2C_SDA_ROUTE     I2C_ROUTELOC0_SDALOC_LOC15  // SDA PC10: route location #15 for I2C0 (TRM 6.3 pg 78)
  #define APP_I2C_SCL_ROUTE     I2C_ROUTELOC0_SCLLOC_LOC15  // SCL PC11: route location #15 for I2C0 (TRM 6.3 pg 75)
#else
  #define APP_I2Cn              I2C1                        // I2C1 peripheral
  #define APP_I2C_SDA_ROUTE     I2C_ROUTELOC0_SDALOC_LOC19  // SDA PC10: route location #19 for I2C1 (TRM 6.3 pg 78)
  #define APP_I2C_SCL_ROUTE     I2C_ROUTELOC0_SCLLOC_LOC19  // SCL PC11: route location #19 for I2C1 (TRM 6.3 pg 75)
#endif

// Si7021 configuration
#define SI7021_SCL_ROUTE_LOC    I2C_ROUTELOC0_SCLLOC_LOC15  // SCL route
#define SI7021_SCL_PORT         gpioPortC                   // port c (UG257 6.4)
#define SI7021_SCL_PIN          11u                         // Pin 11 (UG257 6.4)
#define SI7021_SDA_ROUTE_LOC    I2C_ROUTELOC0_SDALOC_LOC15  // SDA route
...
#define SHTC3_SENSOR_EN_PORT    gpioPortB                   // Sensor Port enabled
